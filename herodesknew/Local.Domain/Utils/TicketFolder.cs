...
{
    public static List<IEnumerable<(int Id, string PathFullName, int TicketId)>> GetTicketSubDirectoriesWithScripts(int[] tickets)
    {
        ...
        var result = (
            ...
            .Select(dir =>
            {
                return (Id: Convert.ToInt32(dir.Name), PathFullName: dir.FullName, ticketScriptFolder.TicketId);
            })
